...
$countries = array('74','38','104','230');
?>
                                        

                                                <form  id="formupdate"  method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                            <div class="tab-content">
                                            <div class="tab-pane active" id="identification" style=" height: 350px; ">
                                        ...
                                        <div class="col-md-5  checkbox-list" style="WIDTH: 36%;">
                                           ...
                                           <input required="" type="radio"  id="uncheck_statut" class="icheck" data-radio="iradio_square-grey"value="0" <?php if (isset($Server->is_Djiant) && $Server->is_Djiant == 0 ) { echo 'checked';} ?> name="statut">  </label>
                                ...
                                <option value="6" <?php  if ($Server->zoom == 6 ) { echo "selected";} ?>>Local</option>
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text"  value ="<?php if (isset($Server->acronyme)){ echo html_entity_decode(stripslashes($Server->acronyme)); } ?>"  name ="acronyme" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Nom complet </label>
                                                    <div class="col-md-9">
                                                        <input type="text" value ="<?php if (isset($Server->nom)){ echo html_entity_decode(stripslashes($Server->nom)); } ?>" name = "nom" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <input type="text" id="site_web" value ="<?php if (isset($Server->url_server)){ echo html_entity_decode($Server->url_server); } ?>" name="site" class="form-control input-sm Djiant-input">
                                        ...
                                        <div class="col-md-9">
                                                        <textarea name="desc"  class="form-control Djiant-input" rows="10"> <?php if (isset($Server->about)){ echo html_entity_decode(stripslashes($Server->about)); } ?></textarea>
                                                    </div>
                                    </div>
                                     </div>
                                            <div class="tab-pane" id="localisation" style=" height: 350px; ">
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">GPS </label>
                                                    <div class="col-md-9">
                                                       <div class="input-group">
                                            <input type="text" name="gps" id="gps" class="form-control input-sm Djiant-input">
                                            <span class="input-group-btn">
                                       ...
                                       <label class="col-md-3 control-label text-left">Lat</label>
                                            ...
                                            <div class="col-md-9">
                                                 <select id='pays_list' name="pays" placeholder="Select Pays"  style='font-size: small;'  class='form-control select2me select input-sm'>
                                                    <option  value=""></option>
                                                    <?php $pays = Pays::trouve_tous();  foreach ($pays as $pays) {?> <option value = "<?php echo $pays->id ; ?> " <?php  if ($Server->pays == $pays->id ) { echo "selected";} ?> ><?php echo $pays->name; ?></option> <?php } ?></select>
                                            </div>
                                                    
                                                    </div>
                                                    <div class="form-group region">
                                                        <?php  if (in_array($Server->pays,$countries)) {
                                                 $Regions = Region::trouve_region_par_id_pays($Server->pays); ?>
                                                     ...
                                                     <div class="col-md-9 ">
                                                        <select id='id_region' name="region"  placeholder="Région" style='font-size: small;'  class='form-control select2me input-sm'>
                                                               <?php  foreach ($Regions as $Region) {?> <option value = "<?php echo $Region->id ; ?> " <?php  if ($Server->region == $Region->id ) { echo "selected";} ?> ><?php echo $Region->name; ?></option> <?php } ?>
                                                        </select>
                                       ...
                                       <label class="col-md-3 control-label text-left">Ville</label>
                                            <div class="col-md-5">
                                                <input name="ville" type="text" class="form-control input-sm Djiant-input" value ="<?php if (isset($Server->ville)){ echo html_entity_decode(stripslashes($Server->ville)); } ?>" required>
                                            </div>
                                            
                                            <div class="col-md-4">
                                                <input name="code_postal"  type="text" placeholder="Code Post"   class="form-control input-sm Djiant-input" name="code_postal" value ="<?php if (isset($Server->code_postal)){ echo html_entity_decode($Server->code_postal); } ?>" required="">
                                            </div>
                                    </div>
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 1 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" value ="<?php if (isset($Server->adr_line_1)){ echo html_entity_decode(stripslashes($Server->adr_line_1)); } ?>" name = "adr1" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 2 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name = "adr2" class="form-control input-sm Djiant-input"  value ="<?php if (isset($Server->adr_line_2)){ echo html_entity_decode(stripslashes($Server->adr_line_2)); } ?>"placeholder="">
                                                    </div>
                                                    </div>
                                                    <div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 3 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" value ="<?php if (isset($Server->adr_line_3)){ echo html_entity_decode(stripslashes($Server->adr_line_3)); } ?>" name = "adr3" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                    </div>
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" name = "phone" class="form-control input-sm Djiant-input" placeholder="phone" value ="<?php if (isset($Server->phone)){ echo html_entity_decode($Server->phone); } ?>">
                                                    </div>
                                ...
                                <div class="tab-pane" id="activite" style=" height: 350px; ">
                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Réseaux </label>
                                                    <div class="col-md-9">
                                                      <select  name="reseaux" placeholder="Select Réseau" class="form-control input-sm select2me select" >
                                                        <option  value=""></option>
                                                        <?php
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Mots clés</label>
                                    <div class="col-md-9">
                                        <input type="text" name="keywords" id="keywords" class="form-control Djiant-input" data-role="tagsinput" value="<?php if (isset($Server->keywords)) { echo$Server->keywords; }  ?>" />
                                          
                                    </div>
                                </div>
                                </div>
                                <div class="tab-pane" id="logo" style=" height: 350px; ">
                                    <div class="form-group">
                                    <label class="control-label col-md-3">Logo</label>
                                        <div class="input-group col-md-9" >
                                                        <div class='logo'>
                            <img src="<?php if(!empty($Server->logo)){ echo 'assets/image/logo/'.$Server->logo; }  else {echo 'assets/image/gris-window.png'; } ?>" id="img" style="  margin: 5px; width: 80%;">
                                                        </div>
                                    ...
                                    <input type="hidden" name="user_id"  value="<?php if (isset($user_id)) { echo$user_id; }  ?>" />
                                        ...
                                        <div class="col-md-4 checkbox-list "  >
                                           ...
                                           <input required="" type="radio" class="icheck" id="uncheck_authorized" value="0" <?php if (isset($Server->authorized) && $Server->authorized == 0 ) { echo 'checked';} ?> name="authorized"> </label>
