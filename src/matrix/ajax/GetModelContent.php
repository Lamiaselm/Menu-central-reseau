...
?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control input-sm " readonly  value="<?php  if(isset($latitude)){  echo   $latitude; } ?>" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" >
                                        <input  class="form-control input-sm " readonly  value="<?php  if(isset($longitude)){  echo   $longitude; } ?>" >
                                     <span class="input-group-addon">
                                                            <i class="glyphicon glyphicon-map-marker" > </i>
