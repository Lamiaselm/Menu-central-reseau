...
if (isset($id_network)&& isset($id_pays)) {
   $Servers = Server::trouve_markers_par_pays_network($id_pays,$id_network);
                                ...
                                <div class="row" id="<?php echo $Server->id; ?>" >
                                 ...
                                 <?php if (isset($Server->nom )) {  echo  html_entity_decode(count_lenght_and_show( stripslashes($Server->nom))); } ?> <span class="number"> <?php  if ( $Server->authorized ==1 ) { echo '<i class="fa fa-check-square-o " ></i>';} ?>   </span></a>
                                     </div>
                                </div>
