		...
		<div class="hor-menu hidden-sm hidden-xs">
			<ul class="nav navbar-nav">
				...
				<li class="mega-menu-dropdown">
					<a data-toggle="dropdown" href="javascript:;" class="dropdown-toggle"  data-close-others="true"> <i class="fa fa-globe" style="font-size: 21px;     vertical-align: sub"></i>
					...
					<?php 
					 ...
					 ?>
					<ul class="dropdown-menu" style="min-width: 700px;height: 800px;">
						<li>
