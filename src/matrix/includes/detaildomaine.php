...
class Detaildomaine{
	...
	protected static $nom_table="detaildomaines"; 
	protected static $champs = array('id', 'id_Domaine','lib_DetailDomaine','description','img','url','is_popular','is_active','logo','is_new');
	public $id;
	public $id_Domaine;
	public $lib_DetailDomaine;
	public $description;
	public $img;
	public $url;
	public $is_popular;
  ...
  public function nom_compler() {
	...
	public  function  existe(){
	 global $bd;
	 $sql  = "SELECT * FROM ".self::$nom_table." ";
    $sql .= "WHERE num_serie = '".$this->num_serie."' ";
	...
	public static function trouve_par_domaine($id_Domaine){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE id_Domaine ='{$id_Domaine}'";
    return  self::trouve_par_sql($q);
	}
  ...
  public static function is_active_in(){
	$q =  "SELECT * FROM ".self::$nom_table;
	$q .= " WHERE is_active ='1' and id in(5,13,17,22)";
    return  self::trouve_par_sql($q);
	}
