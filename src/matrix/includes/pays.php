...
class Pays {
	...
	protected static $nom_table="countries"; 
	protected static $champs = array('id','number','code', 'iso3', 'name','full_name','tel_Indicatif','continent_code','continent_id','display','display_order','longitude','latitude');
	...
	public static function trouve_par_continent_id_display($id){
	$q =  "SELECT id,name FROM ".self::$nom_table;
	$q .= " WHERE continent_id = $id ";
	$q .= " and display = 1 ";
  ...
  }	public static function trouve_51() {
		return self::trouve_par_sql('SELECT * FROM `countries` WHERE `name` IN ("China", "United States of America", "India", "Japan", "Brazil", "Russia", "Germany", "United Kingdom", "France", "Nigeria", "Iceland", "Korea, South", "Denmark", "Hong Kong", "Netherlands", "Norway", "Luxembourg", "Indonesia", "Italy", "Egypt", "Iran", "Turkey", "Thailand", "Vietnam", "Philippines", "Mexico", "Bangladesh", "Spain", "Canada", "Argentina", "South Africa", "Colombia", "Poland", "Saudi Arabia", "Malaysia", "Ukraine", "Morocco", "Taiwan", "Australia", "Venezuela", "Algeria", "Ethiopia", "Peru", "Chile", "Romania", "Belgium", "United Arab Emirates", "Switzerland", "Greece", "Portugal", "Austria") ORDER BY `name` ASC');
  }
