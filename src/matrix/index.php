				...
				<div class="row">
					...
					<div class="col-md-3 " style=" padding-left: 0px; ">
						<div class="portlet light " style="padding-left: 0px; padding-right:  0px;">
							<div class="portlet-title" style="padding : 0px; padding-top: 4px;">
								<div style="" class="caption note">
								 Détails 
							...
							<ul class="nav nav-tabs">
								<li class=" detail-tabs  active" id="identification-tab" >
									<a href="#identification" data-toggle="tab">
									<img  src="assets/image/info-icon.png" width="20px"> </a>
								</li>
								<li class=" detail-tabs" id="localisation-tab">
									<a href="#localisation" data-toggle="tab">
									<img  src="assets/image/2-LocalEconomy.svg" width="20px"></i> </a>
								</li>
								
								<li  class=" detail-tabs" id="activite-tab">
									<a href="#activite" data-toggle="tab">
									<img  src="assets/image/tree.png" width="20px"> </a>
								</li>
								<li class=" detail-tabs" id="logo-tab">
									<a href="#logo" data-toggle="tab">
									<img  src="assets/image/pic.png" width="20px"> </a>
								</li>
							</ul>
							</div>
							<div class="portlet-body ">
									<div class="notification"></div>
										<div id="serverform">
											...
											<div class="tab-pane active" id="identification" style=" height: 400px; ">
										...
										<div class="col-md-5  checkbox-list" style="WIDTH: 36%;">
											...
											<input required type="radio" checked id="uncheck_statut" class="icheck" data-radio="iradio_minimal-grey" value="0" name="statut" >  </label>
                         				...
                         				<div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="text" name = "acronyme" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                	</div>
                                                	<div class="form-group">
                                                    <label class="col-md-3 control-label">Nom complet </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name = "nom" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                	</div>
                                                	<div class="form-group">
											...
											<input type="text" id="site_web" name="site" class="form-control input-sm Djiant-input">
										...
										<div class="col-md-9">
                                                        <textarea name="desc"  class="form-control Djiant-input" rows="10"></textarea>
                                                    </div>
									</div>
                                       ...
                                       <label class="col-md-3 control-label text-left">Ville</label>
                                            <div class="col-md-5">
                                                <input name="ville" type="text" class="form-control input-sm Djiant-input" value="" required>
                                            </div>
                                            
                                            <div class="col-md-4">
                                                <input name="code_postal" type="text" placeholder="Code Post"   class="form-control input-sm Djiant-input" value="" required="">
                                            </div>
                                    </div>
                                                	<div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 1 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name = "adr1" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                	</div>
                                                	<div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 2 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name = "adr2" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                	</div>
                                                	<div class="form-group">
                                                    <label class="col-md-3 control-label">Adress line 3 </label>
                                                    <div class="col-md-9">
                                                        <input type="text" name = "adr3" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                                	</div>
                                    ...
                                    <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" name = "phone" class="form-control input-sm Djiant-input" placeholder="">
                                                    </div>
                                    </div>
                                </div>
                                <div class="tab-pane" id="activite" style=" height: 350px; ">
                                	<div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                      <select placeholder="Select Réseau" name="reseaux" class="select2me form-control input-sm select "  >
                                                      	<option value=""></option>
                                                      	<?php
									...
									<div class="col-md-9">
										<input type="text" name="keywords" class="form-control input-sm Djiant-input" data-role="tagsinput"  />
                                ...
                                <div class="tab-pane" id="logo" style=" height: 350px; ">
                                    ...
                                    <label class="control-label col-md-3">Logo</label>
                                        <div class="input-group col-md-9" style=" margin-bottom: 20px;">
                                                        <div class='logo'>
                			<img src="assets/image/gris-window.png" id="img" style="  margin: 5px;">
            											</div>
									...
									<label class=" col-md-3 control-label" style="padding-right: 15px;">Publier </label>
                                        <div class="col-md-4  checkbox-list"  style="padding-top: 5px;">
                                           ...
                                           <input required="" checked id="uncheck_authorized" type="radio" class="icheck" data-radio="iradio_minimal-grey" value="0"  name="authorized"> </label>
							...
							<div id="static" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                               ...
                               <div id="myNetwork" class="modal fade" tabindex="-1" data-backdrop="static" data-keyboard="false">
                                    <div class="modal-header modalheader-Network">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                    <h4 class="modal-title modaltitle-Network" ></h4>
                                </div>
                                <div class="modal-body modalbody-Network">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn default">Annuler</button>
                                    <button type="button" data-dismiss="modal" id="update-Network" class="btn blue">Enregistrer </button>
                                </div>
                            </div>		 
...
<div class="page-footer">
	<div class="page-footer-inner">
		2020 &copy; Djiant.com ® All rights reserved
	</div>
...
<script src="assets/global/plugins/jquery-tags-input/tagsinput.js" type="text/javascript"></script>
...
<script>
 ...
 $('.modalbody-Network').load('ajax/GetNetworkContent.php?id='+id,function(){       
    });	
});
 ...
 $('.notification').load('ajax/Exportfile.php?network='+network+'&pays='+pays,function() {      
    });
 });
</script>
<script>
...
$(document).on('click','button#update-Network', function() {
$.ajax({
type: "POST",
url: "ajax/updateNetwork.php",
data: $('#Networkupdate').serialize(),
success: function(message){
$(".notification").html(message)
},
error: function(){
alert("Error");
 ...
 $('#domaine').load('ajax/GetNavmenu.php',function(){       
    });
});
   ...
   var id = $(this).attr('id');
    ...
    $('.detail-tabs').removeClass('active');
    $('#identification-tab').addClass('active');
...
<script type="text/javascript"> 
    ...
    $('.modaltitle-Network').html('<i class="fa fa-server"></i> '+$(this).attr('id'));
    $( "#domaine_name" ).show(); 
